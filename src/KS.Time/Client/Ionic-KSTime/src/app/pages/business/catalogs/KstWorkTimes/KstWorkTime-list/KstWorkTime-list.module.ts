...
import { KstWorkTimeListPage } from './KstWorkTime-list.page';
...
@NgModule({
  ...
  declarations: [KstWorkTimeListPage]
})
export class KstWorkTimeListPageModule {}

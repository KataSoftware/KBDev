...
import { KstEmailTemplateListPage } from './KstEmailTemplate-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: KstEmailTemplateListPage
  }
];
...
@NgModule({
  ...
  declarations: [KstEmailTemplateListPage]
})
export class KstEmailTemplateListPageModule {}

...
import { KstProjectFileListPage } from './KstProjectFile-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: KstProjectFileListPage
  }
];
...
@NgModule({
  ...
  declarations: [KstProjectFileListPage]
})
export class KstProjectFileListPageModule {}

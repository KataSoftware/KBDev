...
import { KstProxyRoleListPage } from './KstProxyRole-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: KstProxyRoleListPage
  }
];
...
@NgModule({
  ...
  declarations: [KstProxyRoleListPage]
})
export class KstProxyRoleListPageModule {}

...
import { unProxySettingListPage } from './unProxySetting-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: unProxySettingListPage
  }
];
...
@NgModule({
  ...
  declarations: [unProxySettingListPage]
})
export class unProxySettingListPageModule {}

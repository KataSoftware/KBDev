...
import { KstProxyGeoCityListPage } from './KstProxyGeoCity-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: KstProxyGeoCityListPage
  }
];
...
@NgModule({
  ...
  declarations: [KstProxyGeoCityListPage]
})
export class KstProxyGeoCityListPageModule {}

...
import { KstWorkTimeFileListPage } from './KstWorkTimeFile-list.page';
...
const routes: Routes = [
  {
    path: '',
    component: KstWorkTimeFileListPage
  }
];
...
@NgModule({
  ...
  declarations: [KstWorkTimeFileListPage]
})
export class KstWorkTimeFileListPageModule {}
